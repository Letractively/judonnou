...
public class houghDemo extends JApplet {
	...
	String fileNames[] = {"snip1.png","snip2.png","snip3.png"};
	...
	public void init() {
		...
		linesSlider = new JSlider(JSlider.HORIZONTAL, 1, 100, lines);
	...
	private void processImage(){
		...
		new Thread(){
			public void run(){
				...
				HoughAccImage = createImage(new MemoryImageSource(180, rmax, acc, 0, 180)).getScaledInstance(width, height, Image.SCALE_SMOOTH);
